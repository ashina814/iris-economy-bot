...
assert(marketPanel.panel.fields.some((field) => field.name === "民営商店街"), "ショップホームに商店街の状況が必要です");
...
assert(marketPanelJson.includes("my-trades") && marketPanelJson.includes("listing-new"), "ショップホームに出品・自分の取引の導線が必要です");
